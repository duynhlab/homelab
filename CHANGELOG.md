...
- **RFC-0020 owner decision — all app→DB via pooler**: no direct-to-CNPG exceptions; `payment`'s direct hop marked transitional (returns behind `pgdog-product` at Slice 3); T3-behind-pooler identity nuance added to open questions.
