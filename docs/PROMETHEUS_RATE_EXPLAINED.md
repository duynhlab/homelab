...
### **Query:**
```promql
request_duration_seconds_count{app="demo-go-api"}
```
...
### **Query:**
```promql
rate(request_duration_seconds_count{app="demo-go-api"}[5m])
```
...
### **Query:**
```promql
increase(request_duration_seconds_count{app="demo-go-api"}[5m])
```
...
**Query:**
```promql
sum(request_duration_seconds_count{app="demo-go-api"})
```
...
**Query:**
```promql
sum(rate(request_duration_seconds_count{app="demo-go-api"}[5m]))
```
...
**Query:**
```promql
sum(increase(request_duration_seconds_count{app="demo-go-api"}[$__range]))
```
