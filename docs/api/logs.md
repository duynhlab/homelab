...
|-----------|-------|-----------|
| **Logger** | `github.com/duynhlab/pkg/logger/slogx` v0.3.0 (fleet-wide since 2026-09-24, RFC-0031 Phase 3; v0.3.0 train 2026-09-25) | [ADR-070](../proposals/adr/ADR-070-logging-facade-and-event-catalog/) |
...
| **Design record** | — | [RFC-0014](../proposals/rfc/RFC-0014/) · **[RFC-0031](../proposals/rfc/RFC-0031/) (Implemented 2026-09-25)** → [ADR-070](../proposals/adr/ADR-070-logging-facade-and-event-catalog/) (slog facade, event catalog) · [ADR-071](../proposals/adr/ADR-071-telemetry-event-data-contract/) (access/event schema, privacy) |
