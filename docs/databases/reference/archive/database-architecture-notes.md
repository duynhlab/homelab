# Archived Homelab Notes: Database Architecture

> **Historical learning snapshot — not a source of current platform truth.**
> Use the current [database architecture](../../architecture.md).
...
> operator-managed `auth_query`) — see [fundamentals/connection-pooling.md](../../fundamentals/connection-pooling.md).
