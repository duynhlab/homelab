...
**Coverage**: 10 HTTP services x 3 SLOs + inventory x 2 gRPC SLOs + keycloak x 2 identity SLOs = 34 SLOs, 68 alerts
...
| Layer 2: SLO alerts | 68 alerts (34 SLOs x 2 severities) | Implemented |
