...
**233** — 225 here, minus the 2 gated CNPG topology rules that never deploy, plus
those 10 (the three ADR-055 capacity rules and the three `Keda*` self-health rules landed 2026-09-05). The Sloth-generated 62 are separate by design and are not in this
number.
