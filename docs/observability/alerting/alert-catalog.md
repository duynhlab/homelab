...
Source: `prometheusrules/observability/tempo-alerts.yaml`, `prometheusrules/observability/pyroscope-alerts.yaml`, `prometheusrules/temporal/alerts.yaml`, `prometheusrules/watchdog.yaml`.
