...
#### Use Case 2: "Incident do deploy hay do load?"
...
# 2. Correlate annotations (deployment) với error spike
...
- Hiểu được metrics thay đổi thế nào sau mỗi deploy
