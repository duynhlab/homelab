...
**Fires when**: P95 gRPC server latency >500ms for 10 minutes.

**Severity**: warning

East-west budget is tighter than edge HTTP — high gRPC latency compounds into edge P95.
...
**Resolution**: Same as [MicroserviceHighLatencyP95.md](MicroserviceHighLatencyP95.md) but scoped to gRPC handlers.
