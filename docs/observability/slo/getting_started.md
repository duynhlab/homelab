...
2. **VictoriaMetrics** stack running with VMAgent + VMSingle (ServiceMonitor / VMServiceScrape support)
...
Verify the service is being scraped via VMAgent / VMSingle:
...
# Open: http://localhost:8429/targets — look for the microservices job
```
