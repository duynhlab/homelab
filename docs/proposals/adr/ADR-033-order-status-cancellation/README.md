...
| 2026-08-01 | Accepted / Complete | Cluster-verified: every decision rule exercised live on Kind (FSM ladder incl. `completed → cancelling`, actor matrix, epoch command ids, CAS versioning, RESTOCK_SKIPPED) |
