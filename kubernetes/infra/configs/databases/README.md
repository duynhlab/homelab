...
| Operator | Version | Description | In Use |
|----------|---------|-------------|--------|
| **CloudNativePG** | v1.28.0 | Kubernetes-native operator for PostgreSQL with HA, disaster recovery, and declarative management. | ✅ |
| **Zalando Postgres Operator** | v1.15.1 | Automated HA and operational simplicity for PostgreSQL on Kubernetes. Uses Patroni + Spilo. | ✅ |
