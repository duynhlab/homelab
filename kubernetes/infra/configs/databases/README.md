...
| -------------------- | ------------------------------------------------------------------------ | ------------------------ | ------------------- | -------------------------------------------------------- |
| platform-db          | CNPG built-in :9187 (PodMonitor) + PgBouncer PodMonitor              | CNPG stdout → Vector DaemonSet | Barman Cloud Plugin + ObjectStore | `s3://pg-backups-cnpg/platform-db/`, retention 30d           |
