...
echo ""
echo "Usage:"
echo "  ./scripts/04-build-microservices.sh              # Normal build (use cache, skip existing)"
echo "  ./scripts/04-build-microservices.sh --no-cache   # Rebuild without cache"
echo "  ./scripts/04-build-microservices.sh --force      # Force rebuild all (no cache, skip checks)"