...
import (
	...
	logicv2 "github.com/duynhne/monitoring/services/auth/internal/logic/v2"
...
var authService = logicv2.NewAuthService()

// Login handles HTTP request for user login (v2)
...
// Register handles HTTP request for user registration (v2)
