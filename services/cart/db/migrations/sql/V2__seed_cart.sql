...
INSERT INTO cart_items (id, user_id, product_id, quantity, created_at, updated_at) VALUES
    ...
    (1, 1, 1, 2, NOW() - INTERVAL '3 days', NOW() - INTERVAL '1 day'),   -- Wireless Mouse x2
    (2, 1, 2, 1, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days'),  -- Mechanical Keyboard x1
    (3, 1, 5, 1, NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day'),    -- Webcam HD x1
    
    -- Bob's cart (user_id: 2)
    (4, 2, 3, 1, NOW() - INTERVAL '4 days', NOW() - INTERVAL '4 days'),  -- USB-C Hub x1
    (5, 2, 4, 1, NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days')   -- Laptop Stand x1
