...
import (
	...
	v1 "github.com/duynhne/monitoring/internal/review/web/v1"
	v2 "github.com/duynhne/monitoring/internal/review/web/v2"
...
func main() {
	...
	go func() {
		logger.Info("Starting review service", zap.String("port", port))
