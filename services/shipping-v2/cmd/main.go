...
import (
	...
	"github.com/duynhne/monitoring/services/shipping-v2/config"
	database "github.com/duynhne/monitoring/services/shipping-v2/internal/core"
	v2 "github.com/duynhne/monitoring/services/shipping-v2/internal/web/v2"
...
func main() {
	...
	// API v2 (shipping-v2 service only has v2)
	...
	go func() {
		logger.Info("Starting shipping-v2 service", zap.String("port", cfg.Service.Port))
