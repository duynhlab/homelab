-- =============================================================================
-- Shipping-v2 Service - Seed Data
-- =============================================================================
-- Purpose: Demo shipments for local/dev/demo environments (v2 service)
-- Usage: Run after V1 migration to populate test shipments
-- Note: References order.orders (order_id)
-- Note: Same seed data as shipping service for consistency
-- =============================================================================
